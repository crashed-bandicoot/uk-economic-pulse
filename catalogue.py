CATALOGUE = [
    ...
    dict(key="gdp_us",   label="US GDP Growth",        category="Economic Activity",
         signal_col="gdp_us_yoy",        abs_col="gdp_us",
         unit="% YoY",       decimals=1, higher_is_better=True,  lag="Quarterly · ~1m lag"),
    ...
    dict(key="gold",      label="Gold",                 category="Commodities",
         ...
         unit="% YoY",       decimals=1, higher_is_better=False, lag="Monthly mean"),
    dict(key="uranium",  label="Uranium (URA ETF)",    category="Commodities",
         signal_col="uranium_yoy",       abs_col="uranium",
         unit="% YoY",       decimals=1, higher_is_better=True,  lag="Monthly mean · from 2009"),
    # Markets
    dict(key="dxy",      label="US Dollar (DXY)",      category="Markets",
         signal_col="dxy_yoy",           abs_col="dxy",
         unit="% YoY",       decimals=1, higher_is_better=False, lag="Monthly mean"),
    dict(key="twusd",    label="Trade-Weighted USD",   category="Markets",
         signal_col="twusd_yoy",         abs_col="twusd",
         unit="% YoY",       decimals=1, higher_is_better=False, lag="Monthly mean"),
